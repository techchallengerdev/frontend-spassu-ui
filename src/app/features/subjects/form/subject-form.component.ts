    ...
    <div class="container mt-4">
      ...
      <form [formGroup]="subjectForm" (ngSubmit)="onSubmit()" class="mt-4">
        ...
        <mat-form-field class="w-100 mb-3">
          ...
          <textarea matInput formControlName="description" placeholder="Subject description" rows="4"></textarea>
        ...
        <mat-form-field class="w-100 mb-3">
          ...
          <mat-select formControlName="parentSubject">
            ...
            <mat-option *ngFor="let subject of parentSubjects" [value]="subject.id">
              {{subject.name}}
            </mat-option>
          </mat-select>
        </mat-form-field>
        ...
        <div class="d-flex gap-2 mt-4">
          <button mat-raised-button color="primary" type="submit" [disabled]="subjectForm.invalid || isSubmitting">
