  ...
  template: `
    <div class="container mt-4">
      <mat-card *ngIf="author">
        <mat-card-header>
          <mat-card-title
            >{{ author.firstName }} {{ author.lastName }}</mat-card-title
          >
        ...
        <mat-card-actions>
          <button mat-button [routerLink]="['/v1/autores', author.id, 'edit']">
            EDIT
          </button>
          <button mat-button routerLink="/v1/autores">BACK</button>
        </mat-card-actions>
      </mat-card>
    </div>
  `,
